                    ...
                    <div className="p-3 border-b border-gray-100 dark:border-gray-700/60 flex-shrink-0">
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="w-full pl-8 pr-3 py-2 bg-gray-50 dark:bg-gray-700/50 rounded-xl text-sm text-gray-90 dark:text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 border-0"
                            />
                        </div>
                    </div>
