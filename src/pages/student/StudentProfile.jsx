...
import { User, Mail, Phone, MapPin, Linkedin, Github, GraduationCap, Upload, X, Building2, Briefcase, FileText, Loader2, Trash2, Download } from 'lucide-react';
                            ...
                            {user?.cv ? (
                                <div className="border border-gray-200 dark:border-gray-700 rounded-2xl p-5 w-full text-center space-y-3">
                                    ...
                                    <div className="flex flex-wrap justify-center gap-2">
                                        <button
                                            type="button"
                                            onClick={() => downloadCV(user.cv, `${(user?.name || 'CV').replace(/\s+/g, '_')}_CV.pdf`)}
