...
import { Clock, CheckCircle2, Circle, Plus, Star, MessageSquare, FileText } from 'lucide-react';
...
export default function AssignedTasks() {
    ...
    return (
        <div className="space-y-6 page-enter">
            ...
            <Modal isOpen={!!feedbackModal} onClose={() => { setFeedbackModal(null); setRating(0); setFeedbackText(''); }} title="Review & Rate Task" size="md"
                footer={<>
                    <Button variant="secondary" onClick={() => { setFeedbackModal(null); setRating(0); setFeedbackText(''); }}>Cancel</Button>
                    <Button variant="gradient" disabled={loading || rating < 1} onClick={async () => {
                    ...
                    }}>{loading ? 'Saving...' : 'Submit Feedback'}</Button>
                </>}>
                <div className="space-y-4">
                    ...
                    <div>
                        ...
                        <textarea rows={4} placeholder="What did they do well? What can be improved?" value={feedbackText} onChange={(e) => setFeedbackText(e.target.value)}
