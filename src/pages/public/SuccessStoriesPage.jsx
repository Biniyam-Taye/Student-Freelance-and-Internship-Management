...
export default function SuccessStoriesPage() {
    ...
    return (
        <div className={`min-h-screen ${mode === 'dark' ? 'bg-slate-900 text-white' : 'bg-slate-50 text-slate-900'} font-sans transition-colors duration-300`}>
                    ...
                    <div className="px-5 sm:px-8">
                        <div className="flex justify-between items-center h-16">
                            ...
                            <div className="hidden md:flex items-center gap-8 font-medium">
                                <Link to="/#how-it-works" className={`hover:text-blue-500 transition-colors text-sm ${mode === 'dark' ? 'text-slate-300' : 'text-slate-600'}`}>How It Works</Link>
                                <Link to="/#features" className={`hover:text-blue-500 transition-colors text-sm ${mode === 'dark' ? 'text-slate-300' : 'text-slate-600'}`}>Features</Link>
                                <Link to="/success-stories" className="text-blue-600 dark:text-blue-400 text-sm font-bold border-b-2 border-blue-600">Success Stories</Link>
                            </div>
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <Link to="/login" className="inline-flex items-center justify-center bg-blue-600 hover:bg-blue-700 text-white px-5 py-2 rounded-full text-sm font-bold transition-all shadow-md shadow-blue-500/30 whitespace-nowrap flex-shrink-0">
                                    Sign In
                                </Link>
                            </div>
                        </div>
            ...
            {/* Hero Section */}
            <section className={`relative pt-60 pb-24 ${mode === 'dark' ? 'bg-slate-900' : 'bg-white'} overflow-hidden`}>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div>
                            <span className="inline-block text-xs font-bold uppercase tracking-widest text-blue-600 dark:text-blue-400 bg-blue-50 dark:bg-blue-900/30 px-3 py-1 rounded-full mb-6">
                                Impact & Results
                            </span>
                            <h1 className={`text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tight leading-[1.1] mb-6 ${mode === 'dark' ? 'text-white' : 'text-slate-900'}`}>
                                Real Stories from <span className="gradient-text">Real Talent</span>
                            </h1>
                            <p className={`text-lg md:text-xl font-medium mb-10 leading-relaxed ${mode === 'dark' ? 'text-slate-300' : 'text-slate-600'}`}>
                                Discover how Ethiopian students are launching their careers and how companies are finding exceptional talent through our platform.
                            </p>
                            <div className="flex flex-wrap gap-4">
                                <Link to="/register" className="flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-8 py-4 rounded-full text-lg font-bold transition-all shadow-xl shadow-blue-500/20 active:scale-95 whitespace-nowrap">
                        ...
                        <div className="relative mt-8 lg:mt-0">
                            ...
                            />
                            {/* Floating Card */}
                            <div className={`absolute -bottom-6 -left-6 p-6 rounded-2xl shadow-xl border ${mode === 'dark' ? 'bg-slate-800 border-slate-700' : 'bg-white border-slate-100'} hidden md:block max-w-[240px]`}>
                                ...
                                <p className="text-xs text-slate-500 leading-relaxed">
                                    Aman Gebre just secured a Full Stack role at Safaricom Ethiopia!
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <section className="py-24 relative overflow-hidden">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div className="text-center mb-20">
                        <span className="text-blue-600 dark:text-blue-400 font-bold tracking-widest uppercase text-sm">Your Journey</span>
                        <h2 className="text-4xl md:text-5xl font-black mt-4 mb-6">Built for Your <span className="gradient-text">Professional Growth</span></h2>
                        <p className={`text-lg max-w-2xl mx-auto ${mode === 'dark' ? 'text-slate-400' : 'text-slate-600'}`}>
                            We don't just find you jobs. We provide a structured path to transition from a student to a high-demand professional.
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                        {[
                            ...
                            <div key={i} className={`relative p-8 rounded-[32px] border group hover:-translate-y-2 transition-all duration-300 ${mode === 'dark' ? 'bg-slate-800/40 border-slate-700/50 hover:border-blue-500/50' : 'bg-white border-slate-100 hover:border-blue-200 shadow-sm hover:shadow-xl'}`}>
                                <div className={`w-14 h-14 rounded-2xl bg-gradient-to-br ${color} flex items-center justify-center text-white mb-6 shadow-lg transform group-hover:rotate-6 transition-transform`}>
                                    <Icon size={28} />
                                </div>
                                <div className="text-5xl font-black opacity-10 mb-2 leading-none">{step}</div>
                                ...
                                <div className={`absolute bottom-0 left-8 right-8 h-1 bg-gradient-to-r ${color} rounded-t-full scale-x-0 group-hover:scale-x-100 transition-transform origin-left`} />
                            </div>
                        ))}
                    </div>
                </div>
            ...
            <section className={`py-24 ${mode === 'dark' ? 'bg-slate-800' : 'bg-slate-50'}`}>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                                ...
                                {[
                                    ...
                                    <div key={i} className="flex gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p className={`text-sm ${mode === 'dark' ? 'text-slate-400' : 'text-slate-600'}`}>{item.desc}</p>
                                        </div>
                                    </div>
                                ))}
                            </div>
                        ...
                        <div className="order-1 lg:order-2">
                            <div className="grid grid-cols-2 gap-4">
                                <img src="https://images.unsplash.com/photo-1521737711867-e3b97375f902?auto=format&fit=crop&q=80&w=400" alt="Team" className="rounded-2xl shadow-lg" />
                                <img src="https://images.unsplash.com/photo-1519389950473-47ba0277781c?auto=format&fit=crop&q=80&w=400" alt="Work" className="rounded-2xl shadow-lg mt-8" />
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    >
                        ...
                        <div className="relative z-10 max-w-3xl mx-auto">
                            ...
                            <p className="text-blue-100/90 text-lg md:text-xl mb-12 font-medium leading-relaxed">
                                Join over 5,000 students and 500 companies in Ethiopia's <br className="hidden md:block" />
            ...
            <footer className={`${mode === 'dark' ? 'bg-slate-950' : 'bg-slate-900'} text-white`}>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
                        ...
                        <div className="lg:col-span-2">
                            ...
                            <p className="text-slate-400 text-sm leading-relaxed mb-6 max-w-xs">
                                The ultimate platform connecting ambitious Ethiopian students with top companies.
                            </p>
                            <div className="space-y-2 mb-6 text-sm text-slate-400">
                                <div className="flex items-center gap-2">
                                    <MapPin size={14} className="text-blue-400" /> Addis Ababa, Ethiopia
                                </div>
                                <div className="flex items-center gap-2">
                                    <Mail size={14} className="text-blue-400" /> hello@frelaunch.et
                                </div>
                            </div>
                        </div>
                        ...
                        {/* Platform Links */}
                        <div>
                            <h4 className="font-bold text-white text-sm mb-5 uppercase">Platform</h4>
                            <ul className="space-y-3">
                                <li><Link to="/student/browse" className="text-sm text-slate-400 hover:text-blue-400">Browse Jobs</Link></li>
                                <li><Link to="/recruiter/post" className="text-sm text-slate-400 hover:text-blue-400">Post a Job</Link></li>
                                <li><Link to="/login" className="text-sm text-slate-400 hover:text-blue-400">Sign In</Link></li>
                            </ul>
                        </div>

                        {/* Company Links */}
                        <div>
                            <h4 className="font-bold text-white text-sm mb-5 uppercase">Useful Links</h4>
                            <ul className="space-y-3">
                                <li><a href="/#how-it-works" className="text-sm text-slate-400 hover:text-blue-400">How It Works</a></li>
                                <li><Link to="/success-stories" className="text-sm text-slate-400 hover:text-blue-400">Success Stories</Link></li>
                                <li><Link to="/register" className="text-sm text-slate-400 hover:text-blue-400">Register Now</Link></li>
                            </ul>
                        </div>

                        {/* Social */}
                        <div>
                            <h4 className="font-bold text-white text-sm mb-5 uppercase">Follow Us</h4>
                            <div className="flex gap-4">
                                <Twitter size={20} className="text-slate-400 hover:text-blue-400 cursor-pointer" />
                                <Linkedin size={20} className="text-slate-400 hover:text-blue-400 cursor-pointer" />
                                <Github size={20} className="text-slate-400 hover:text-blue-400 cursor-pointer" />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="border-t border-slate-800">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5 flex flex-col sm:flex-row justify-between items-center gap-4 text-sm text-slate-500">
                        <p>&copy; {new Date().getFullYear()} Frelaunch Inc. All rights reserved.</p>
